                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="https://iimnet.com/dashboard/user_volunteer_view.php"
                                aria-expanded="false">
                                <i class="mdi mdi-border-none"></i>
                                <span class="hide-menu">IIMnet User Volunteer Details</span>
                            </a>
                        </li>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 align-self-center">
                        <h4 class="page-title">IIMnet User Volunteer Details</h4>
     ...
     <td><?php echo $file['first_name']; ?></td>
      <td><?php echo $file['last_name']; ?></td>
       ...
       <td><?php echo $file['city']; ?></td>
        <td><?php echo $file['whatsup_number']; ?></td>
      <td><?php echo $file['language']; ?></td>
      <td><?php echo $file['category_type']; ?></td>
       <td><?php echo $file['age_group']; ?></td>
        <td><?php echo $file['volunteer_timeline']; ?></td>
      ...
      <div class="modal-dialog">
        ...
        <div class="col-sm-12">
          ...
          <div class="form-group">
           ...
           <textarea name="answer" class="form-control" id="help-you" cols="5" rows="5" placeholder=""   value="" disabled><?php echo $file['whatsup_number']; ?></textarea>
          </div>
           <div class="form-group">
            <label for="" style="color:black;">Language</label>
            <textarea name="answer" class="form-control" id="help-you" cols="5" rows="5" placeholder=""   value="" disabled><?php echo $file['language']; ?></textarea>
          </div>
           <div class="form-group">
           ...
           <div class="form-group">
            <label for="" style="color:black;">Volunteer Timeline</label>
            <textarea name="answer" class="form-control" id="help-you" cols="5" rows="5" placeholder=""   value="" disabled><?php echo $file['volunteer_timeline']; ?></textarea>
          </div>
           <div class="form-group">
