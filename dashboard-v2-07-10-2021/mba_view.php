    ...
    setTimeout(function() {
        let alert = document.querySelector(".alert");
            alert.remove();
               ...
               <?php if(isset($_SESSION['success_status'])): ?>
                     <div class="col-sm-5 alert alert-success alert-dismissible fade show container">
...
<!--<input type='submit' class="bb" value='Delete' name='but_delete'>-->
   ...
   <ul class = "dropdown-menu ul-drp-dwn-menu dr" role = "menu">
      ...
      <!--<li ><a href="delete_mul_careers.php"><span style="color:#ffffff;">Delete</span></a></li>-->
            ...
            $sql = "SELECT * FROM iim_mba order by id desc";
...
{
	document.frm.action = "mba_edit_mul";
	document.frm.submit();		
}
function delete_records() 
{
	document.frm.action = "mba_delete_mul";
	document.frm.submit();
}
    </script>
