...
<div class="container">
<form method="post" action="volunteer_update_mul">

<?php
for($i=0; $i<$chkcount; $i++)
{
	$id = $chk[$i];			
	$res=$MySQLiconn->query("SELECT * FROM iim_volunteer WHERE id=".$id);
	...
	<div class="modal-dialog">
        ...
        <div class="col-sm-12">
          ...
          <input type="text" class="form-control" name="language[]" value="<?php echo $row['language']; ?>" />
           ...
           <div class="form-group">
            <label for="" style="color:black;">Age Group</label>
          ...
          <div class="form-group">
           ...
           <input type="text" class="form-control" name="volunteer_timeline[]" value="<?php echo $row['volunteer_timeline']; ?>" />
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="" style="color:black;">IP Adress</label>
...
<a href="https://iimnet.com/dashboard/volunteer_view" class="btn btn-large btn-success"> <i class="glyphicon glyphicon-fast-backward"></i> &nbsp; cancel</a>
