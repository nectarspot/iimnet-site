...
.display-flex {display: inline-flex; align-items: center;}
.align-none {
    margin-left: 5px;
}
                    ...
                    <div class="navbar-brand nav-logo" >
                        <a href="index.php" class="logo">
                            ...
                            <b class="logo-icon">
                                ...
                                <!-- Light Logo icon -->
                                <!--<img src="https://theindianharvest.com/images/logo1.png" alt="homepage" class="light-logo" style="height:auto; width: 86px;"/>-->
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 align-self-center">
                        <h4 class="page-title">IIMnet Contact Details</h4>
        ...
        <div class="col-sm-12">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <input type="text" name="answer" class="form-control" id="help-you" placeholder=""   value="<?php echo $file['time_to_call']; ?>" disabled>
          </div>
           <div class="form-group">
...
{
	document.frm.action = "contact_delete_mul";
	document.frm.submit();
}
    </script>
