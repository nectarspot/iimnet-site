   ...
   <div id="Modal_View_<?php echo $file['id']; ?>" class="modal fade" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="col-sm-12">
          ...
          <div class="form-group">
            <label for="" style="color:#1b48b2;">Last Name</label>
          ...
          <div class="form-group">
            <label for="" style="color:#1b48b2;">Email</label>
           <input type="text" name="answer" class="form-control" id="help-you" placeholder=""   value="<?php echo $file['email']; ?>" disabled>
          </div>
          
           <div class="form-group">
            <label for="" style="color:#1b48b2;">Phone </label>
            <input type="text" name="answer" class="form-control" id="help-you" placeholder=""   value="<?php echo $file['phone_number']; ?>" disabled>
          </div>
           <div class="form-group">
            <label for="" style="color:#1b48b2;">City</label>
            <input type="text" name="answer" class="form-control" id="help-you" placeholder=""   value="<?php echo $file['city']; ?>" disabled>
          </div>
           <div class="form-group">
            <label for="" style="color:#1b48b2;">Internship</label>
           <input type="text" name="answer" class="form-control" id="help-you" placeholder=""   value="<?php echo $file['internship']; ?>" disabled>
          </div>
           <div class="form-group">
            <label for="" style="color:#1b48b2;">Internship Type</label>
            <input type="text" name="answer" class="form-control" id="help-you" cols="5" rows="5" placeholder=""   value="<?php echo $file['internship_type']; ?>" disabled>
          </div>
           <div class="form-group">
            <label for="" style="color:#1b48b2;">Start Date</label>
            <input type="text" name="answer" class="form-control" id="help-you" cols="5" rows="5" placeholder=""   value="<?php echo $file['start_date']; ?>" disabled>
          </div>
           <div class="form-group">
            <label for="" style="color:#1b48b2;">End Date</label>
            <input type="text" name="answer" class="form-control" id="help-you" cols="5" rows="5" placeholder=""   value="<?php echo $file['end_date']; ?>" disabled>
          </div>
           <div class="form-group">
            <label for="" style="color:#1b48b2;">Brief description about yourself</label>
           ...
           <div class="form-group">
            <label for="" style="color:#1b48b2;">Brief description about dream internship</label>
          ...
          <div class="form-group">
            <label for="" style="color:#1b48b2;">Internship Position</label>
            <input type="text" name="answer" class="form-control" id="help-you" cols="5" rows="5" placeholder=""   value="<?php echo $file['position']; ?>" disabled>
          </div>
         
          <div class="form-group">
            <label for="" style="color:#1b48b2;">Dropbox, Google Drive link</label>
            <input type="text" name="answer" class="form-control" id="help-you" placeholder=""   value="<?php echo $file['drive_link']; ?>" disabled>
          </div>
            <div class="form-group">
            <label for="" style="color:#1b48b2;">Status</label>
