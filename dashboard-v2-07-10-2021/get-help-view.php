            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 align-self-center">
                        <h4 class="page-title">IIMnet Covid-19  Details</h4>
                        
                         <!--<span class="blue-font">( Click on download button to the download file )</span>-->
                         
   <?php if(isset($_SESSION['error_gethelp'])): ?>
                     <div class="col-sm-5 alert alert-danger alert-dismissible fade show container">
        <strong>Error!</strong>  <?php echo   $_SESSION["error_gethelp"]; ?>
        <button type="button" class="close" data-dismiss="alert">&times;</button>
    </div>
     <?php endif; ?>
<?php unset($_SESSION['error_gethelp']); ?>
...
{
	document.frm.action = "gethelp_edit_mul";
	document.frm.submit();		
}
function delete_records() 
{
	document.frm.action = "gethelp_mul_delete";
	document.frm.submit();
}
    </script>
