...
// $user = "root";
// $password = "";
// $dbhost = "34.121.13.168";
// $link = mysqli_connect($dbhost, $user, $password, $database) or die("Unable to connect to '$dbhost'");

// mysql_select_db($database) or die("Could not open the database '$database'");

$conn = mysqli_connect("34.121.13.168", "root", "");
if (!$conn) 
{
...
$sql = "INSERT INTO iimnet_contact (name,email,  phone_number, time_to_call,description,date,ip_address)
 VALUES ('$name',   '$email',   '$phone_number', '$time_to_call', '$description','$current_date','$ipaddress')";
 //$sql = mysql_insert_id();
       ...
       <table border='0' cellpadding='0' cellspacing='0' align='center' width='600' style='border-collapse: collapse; border-spacing: 0; padding: 0; max-width: 600px;' class='wrapper'>
         <tr>
           <td style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 20px 20px 0px 20px; font-family: sans-serif;'>
               ...
               <p>$name is interested to join us as Contact Us. Please find the details <a href='https://iimnet.com/dashboard/index'> here. </a></p>
