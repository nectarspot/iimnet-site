...
$sql = "INSERT INTO iim_mba (first_name, last_name,email,  phone_number, city,internship,internship_type,answer,answer1,position,drive_link,description, file_name, status,date,ip_address)
 VALUES ('$first_name', '$last_name',  '$email',   '$phone_number', '$city', '$internship','$internship_type', '$answer', '$answer1', '$position','$drive_link','$description', '$file_name','$status','$current_date','$ipaddress')";
 //$sql = mysql_insert_id();
      ...
      <table bgcolor='#1b48b2' border='0' cellpadding='0' cellspacing='0' align='center' width='600' style='border-collapse: collapse; border-spacing: 0; padding: 0; max-width: 600px;' class='wrapper'>
        <tr>
          <td align='center' valign='top' style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 40px; font-size: 28px; font-weight: bold; color: #ffffff; font-family: sans-serif;' class='header'>
             IIMnet MBAs Internship Application 2021
          </td>
        </tr>
       </table>
     </td>
