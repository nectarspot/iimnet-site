...
<meta name="description" content="Interview Questions." />
    ...
    <meta property="og:title" content="IIMnet Freelancing | IIMnet" />
    <title>IIMnet Freelancing | IIMnet</title>
...
<div class="top-section-pad">
    <div class="container">
    <center>
<h1 class="main-heading mb-half"><mark>IIMnet Freelancing</mark> Application 2021</h1>
</center>


        <div class="ptb-3">
        <div class="form-bg">  
                <form  method="post" action="https://iimnet.com/iim_freelancing" id="my_captcha_form" class="app-form fs-form fs-form-full"  enctype="multipart/form-data" >
               <div class="row">
               <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                   ...
                   <input type="text" name="city" class="form-input" id="full_name" required placeholder="City">
                      ...
                      <div class="col-md-6">
                         <label for="event-selection" class="hidden-label">*I'am looking for (Paid or Unpaid) Freelancing</label>
                          <select name="freelancing" class="form-input" id="event-selection" required>
                            <option value="">Select your Freelancing</option>
                   ...
                   <div class="col-md-12">
                        <p class="fs-1rem"> Which of the following Freelancing type(s) are you looking for?*</p>
                      <label for="webform_type_of_project_checkbox_15" class="container-checkbox">Online - Remote Freelancing
                        <input id="webform_type_of_project_checkbox_15" type="checkbox" name="freelancing_type[]" value="Online - Remote Freelancing">
                        <span class="checkmark"></span>
                      </label>
                      <label for="webform_type_of_project_checkbox_14" class="container-checkbox">In Person at Client Office(s)
                        <input id="webform_type_of_project_checkbox_14" type="checkbox" name="freelancing_type[]"  value="In Person at Client Office(s)">
                        <span class="checkmark"></span>
                      </label>
                      <label for="webform_type_of_project_checkbox_16" class="container-checkbox">Does Not Matter - I am looking for a quality project
                        <input id="webform_type_of_project_checkbox_16" type="checkbox" name="freelancing_type[]"  value="Does Not Matter - I am looking for a quality project">
                        <span class="checkmark"></span>
                      </label>
                      <label for="webform_type_of_project_checkbox_19" class="container-checkbox">Others
                        <input id="webform_type_of_project_checkbox_19" type="checkbox" name="freelancing_type[]"  value="Others">
                        <span class="checkmark"></span>
                      </label>
                   </div>
                    <div class="col-md-6">
                                            <div class="calendar" id="datetimepicker1">
                                                <label>Freelancing Start Date</label>
                                               
                                                <input type="date" class="form-input" name="start_date" placeholder="Freelancing Start Date"  required>
                                            </div>
                                       
                    </div>
                    <div class="col-md-6">
                                            <div class="calendar" id="datetimepicker1">
                                                <label>Freelancing End Date</label>
                                               
                                                <input type="date" class="form-input" name="end_date" placeholder="Freelancing End Date"  required>
                                            </div>
                   ...
                   <div class="col-md-12">
                    <label for="help-you" class="hidden-label">Brief description about your dream Freelancing*</label>
                    <textarea name="answer1" class="form-textarea" id="help-you" cols="30" rows="15" placeholder="Brief description about your dream Freelancing" required></textarea>     
                   </div>                 
                   <div class="col-md-12">
                        <p class="fs-1rem"> Which Freelancing position(s) are you interested in (select at most three)?*</p>
                      <label for="webform_type_of_project_checkbox_1" class="container-checkbox">Accounting
                        <input id="webform_type_of_project_checkbox_1" type="checkbox" name="position[]" value="Accounting">
                        <span class="checkmark"></span>
                      </label>
                      <label for="webform_type_of_project_checkbox_2" class="container-checkbox">Analytics
                        <input id="webform_type_of_project_checkbox_2" type="checkbox" name="position[]" value="Analytics">
                        <span class="checkmark"></span>
                      </label>
                      ...
                      <label for="webform_type_of_project_checkbox_5" class="container-checkbox">Media & PR
                        <input id="webform_type_of_project_checkbox_5" type="checkbox" name="position[]" value="Media & PR">
                        <span class="checkmark"></span>
                      </label>
                   ...
                   <!--</div>-->
                   <div class="col-md-12">
                     <p class="fs-1rem"> Submit your resume (Dropbox, Google Drive link, etc.) </p>
                    <textarea name="drive_link" class="form-textarea" id="help-you" cols="30" rows="15" required placeholder="(Please ensure that document is visible to everyone)"></textarea>       
                   </div>
                   <!--<div class="col-md-12">
                    ...
                    <textarea name="answer6" class="form-textarea" id="help-you" cols="30" rows="15"  placeholder="Any other information"></textarea>       
                   </div>
                      <div class="col-md-12">
                          <p class="fs-1rem"> Submit your recent project (Dropbox, Google Drive link, etc.)</p>
                      <div class="form-group">
                      
                        <label for="file-upload" class="file-upload btn btn-primary btn-block rounded-pill shadow" class="hidden-label"><i class="fa fa-upload mr-2"></i>Upload you Projects
                          <input id="file-upload" type="file"  name="file" value="Upload File" />
                        </label>
