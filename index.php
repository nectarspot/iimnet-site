...
<html lang="en">
<head>
<meta name="description" content="IIMnet is the largest online network of pre-screened management professionals which powers social recruiting and project based needs by leveraging curated crowd-sourcing framework."/>
<meta property="og:description" content="IIMnet is the largest online network of pre-screened management professionals which powers social recruiting and project based needs by leveraging curated crowd-sourcing framework."/>
<meta property="og:title" content="IIMnet is a network of professionals" />
<title>IIMnet is a network of professionals</title>
        ...
        <div class="container wrapper">
         <div class="row">
            <div class="col-lg-6 banner-text-div">
                ...
                <a  aria-label="Know More" href="#why-we-exist" class="btn-blue-white mr-3 xs-center learn-more-btn">Learn More ➞</a>
                     <a  aria-label="Know More" href="/internship/hire-mba" class="transparent-btn-blue xs-center mba-btn">Hire MBAs ➞</a>
                     </div>
                     
               <div class="dropdown mt-4">
  <button onclick="myFunction()" class="dropbtn"><i class="fas fa-search blue-font search-icon"></i> I'm looking... <i class="fas fa-angle-down blue-font down-icon float-right"></i> </button>
  <div class="clear-fix"></div>
  <div id="myDropdown" class="dropdown-content">
    <a  aria-label="Know More" href="/internship"><i class="fas fa-dot-circle mr-2"></i> I am looking for an internship</a>
    <a  aria-label="Know More" href="/internship/hire-mba"><i class="fas fa-dot-circle mr-2"></i> I am looking to hire MBAs</a>
    <a  aria-label="Know More" href="/helpline"><i class="fas fa-dot-circle mr-2"></i> COVID-19 helpline (new)</a>
  </div>
</div>
        </div>
         <div class="col-lg-6 tab-mtb2">
  <div class="banner-img-div">
      <img src="images/banner-img.png" width="600" height="450" alt="Banner Image" class="img-back">
              <div class="details-box">
                <ul class="banner-grid">
                  ...
                  <li>
                    <p><b>Platform</b></p>
                    <p>
                      <a href="https://www.facebook.com/IIMnet/" aria-label="Facebook" target="_blank" rel="noopener"><i class="fab fa-facebook-f banner-icons"></i></a>
                      <a href="https://www.linkedin.com/showcase/iimnet-com-india%27s-largest-online-network-of-pre-screened-management-professionals" aria-label="Linkedin" target="_blank" rel="noopener"><i class="fab fa-linkedin-in banner-icons"></i></a>
                      <a href="https://twitter.com/iimnetjobs" aria-label="Twitter" target="_blank" rel="noopener"><i class="fab fa-twitter banner-icons"></i></a>
                      </p>
                  </li>
                </ul>
              </div>
...
<div class="ns-partners ns-awards ptb-3">
    ...
    <a name="about" class="fixed-header-part"></a>
<div class="section-5 ptb-5">
   ...
   <a name="why-we-exist" class="fixed-header-part"></a>
  ...
  <div class="container wrapper">
    <h2 class="sub-heading blue-font  text-center">Why we <span class="uline">Exist</span></h2>
                ...
                <div class="c-table-table">
                    ...
                    <div class="c-table-column">
                        <div class="c-table-rowcell"><div class="table-headline">IIMnet</div></div>
                        <div class="c-table-rowcell ceentr-grey"><div class="table-row-value">Pre-Vetted Interns & Freelancers</div></div>
                        
                        <div class="c-table-rowcell"><div class="table-row-value">Fixed </div></div>
                        <div class="c-table-rowcell ceentr-grey"><div class="table-row-value">Best in Class</div></div>
                        <div class="c-table-rowcell"><div class="table-row-value">Unbiased</div></div>
                        <div class="c-table-rowcell ceentr-grey"><div class="table-row-value">Full</div></div>
                    </div>
                    <div class="c-table-column">
                    ...
                    <div class="c-table-column">
                        ...
                        <div class="c-table-rowcell ceentr-grey">
                            <div class="c-table-row-value"><img src="images/table-close-icon.svg" alt="" /></div>
                        </div>
                    </div>
                </div>
    ...
    <div class="carousel-item active">
     <div class="compare-slide w-slide">
                            <div class="compare-card">
                                ...
                                <div class="row prom">
                                    <div class="c-table-rowcell-copy ceentr-grey  border-right">
                                       <div class="table-row-value bigger blue-font fw-600">
                                        IIMnet
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="c-table-rowcell-copy ceentr-grey border-right"><div class="table-headline blue-font">Marketplace(s)</div></div>
                                    <div class="c-table-rowcell-copy ceentr-grey no-border"><div class="table-row-value">Very Low to Medium</div></div>
                                </div>
                                
                                <div class="row prom">
                                    <div class="c-table-rowcell-copy border-right"><div class="table-headline blue-font">In-house</div></div>
                                    <div class="c-table-rowcell-copy"><div class="table-row-value">Varies</div></div>
                                </div>
                                <div class="row">
                                    <div class="c-table-rowcell-copy ceentr-grey  border-right"><div class="table-headline blue-font">Agencies</div></div>
    ...
    <div class="carousel-item">
     <div class="compare-slide w-slide">
                            <div class="compare-card">
                                ...
                                <div class="row prom">
                                    <div class="c-table-rowcell-copy ceentr-grey  border-right">
                                       <div class="table-row-value bigger fw-600 blue-font">IIMnet</div>
                                    </div>
                                    <div class="c-table-rowcell-copy ceentr-grey no-border"><div class="table-row-value bigger">Fixed</div></div>
                                </div>
                                <div class="row">
                                    <div class="c-table-rowcell-copy border-right"><div class="table-headline blue-font">Marketplace(s)</div></div>
                                ...
                                <div class="row">
                                    <div class="c-table-rowcell-copy  border-right"><div class="table-headline blue-font">Agencies</div></div>
            ...
            <div class="row tab-column-reverse">
                <div class="col-lg-7 wow fadeInLeft tab-mtb2" data-wow-duration="1s">
                   ...
                   <div class="col-lg-5 wow fadeInRight mob-mt2" data-wow-duration="1s">
                        ...
                        <a aria-label="link" href="/internship" class="btn-blue-white full-width tab-center">Hire Interns ➞</a>
                    </div>
  ...
  <div class="container wrapper">
    <h2 class="sub-heading blue-font  text-center">Build and Grow businesses with help of <span class="uline">Interns and Freelancers</span></h2>
     <div class="row align-item-center">
            <div class="col-md-7">
              <div class="video">
                <iframe class="iframe-video" width="560" height="315" src="https://www.youtube.com/embed/BMMMVqbmNkE" loading="lazy" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            ...
            <div class="col-md-5 tab-mtb2">
              ...
              <div class="row">
                <div class="col-lg-3 col-md-4">
                  <img data-class="LazyLoad" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="  data-src="images/pinar-yildirim.png" width="100" height="100" alt="Pinar Yildirim" class="test-icon mob-center">
                </div>
                <div class="col-lg-9 col-md-8">
                   <span><b>Pinar Yildirim, PhD, MS</b></span> <br>
...
<a name="join" class="fixed-header-part"></a>
<div class="ptb-5 case-studies light-blu-bg wow fadeInLeft" data-wow-duration="2s">
    <div class="container-fluid full-wrapper">
        <div class="container wrapper">
          ...
          <div class="row  align-item-center">
                <div class="offset-1 col-lg-5 col-md-6 col-sm-6 wow fadeInLeft" data-wow-duration="1s">
                    <div class="case-study img-hover">
                        <a href="/internship/project" aria-label="Internships/Projects"><div class="cs-image">
                           ...
                           <span class="services-tag">Apply as an Intern ➞</span>
                           </div>
                           <!-- <div class="cs-topic">
                ...
                <div class="col-lg-5 col-md-6 col-sm-6 wow fadeInRight xs-mt2" data-wow-duration="1s">
                  <div class="case-study img-hover">
                        <a href="/internship" aria-label="Interns/Freelancers"><div class="cs-image img-hover">
                           <img width="530" height="400" class="brtlr" data-class="LazyLoad" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="  data-src="images/join-img2.png" alt="image">
                            <span class="services-tag">Hire Interns ➞</span>
                           </div>
                           <!-- <div class="cs-topic">
...
<div class="ptb-5 wow fadeInLeft" data-wow-duration="2s">
  <div class="container wrapper">
    <h2 class="sub-heading blue-font  text-center">By the time the Intern completes your Project, <span class="uline">you may have</span></h2>
    <div class="row">
...
<div class="container-band-bg">
  <div class="container wrapper">
    <div class="row align-item-center">
      <div class="col-lg-8">
        <h5 class="white-font fw-700">Scale Your Business with Pre-Vetted MBA Interns.</h5>
        <span class="white-font mb-2 d-block fs-15">(Hire Now, Free for a Limited Time)</span>
      </div>
      <div class="col-lg-4">
        <a href="/internship/hire-mba" aria-label="Contact Us" class="btn-white d-block tab-center float-right tab-float-none -mba-btn">Hire MBAs ➞</a>
...
<div id="bkgOverlay" class="backgroundOverlay"></div>
    <div id="delayedPopup" class="delayedPopupWindow">
              <a href="#" id="btnClose"><i class="fas fa-times-circle"></i></a>
             <h3 class="sub-heading blue-font t-align-center">COVID-19 Helpline</h3> 
              <div class="formDescription text-center">
                  <p>We have created a helpline page to provide COVID-19 help </p>
                  <a href="/helpline" class="btn-blue-white mob-center">Learn More ➞</a>
