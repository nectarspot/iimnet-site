    ...
    setTimeout(function() {
        ...
        <div class="table-wrapper table-responsive">
           ...
           <table id="example" class="table-striped"> 
            ...
            $sql = "SELECT * FROM iimnet_contact order by id desc";
  ...
  <div class="btn-group" style="width:30px;"><a class="btn btn-primary btn_toggle" data-toggle="modal" href="#Modal_View_<?php echo $file['id']; ?>" ><i class="fa fa-eye" aria-hidden="true"></i></a>
     ...
     <td><?php echo $file['name']; ?></td>
      ...
      <td><?php echo $file['ip_address']; ?></td>
				...
				<a href="contact-delete.php?id=<?php echo $file['id']; ?>" class="btn btn-danger btn-sm1 " style="width:28px; padding: 6px 0px; "><i class="fa fa-trash"></i></a>
                        </td>
    </tr>
      ...
      <div class="modal-dialog">
        ...
        <div class="col-sm-12">
          <div class="form-group">
            ...
            <!--<textarea name="name" class="form-control" id="help-you" cols="2" rows="2" placeholder=""   value="" ><?php echo $file['date']; ?></textarea>-->
            <input type="text" name="date" class="form-control" value="<?php echo $file['name']; ?>" disabled/>
          </div>
          <div class="form-group">
           ...
           <input type="text" name="time" class="form-control" value="<?php echo $file['email']; ?>" disabled/>
          </div>
           ...
           <div class="form-group">
            ...
            <input type="text" name="persons" class="form-control" value="<?php echo $file['phone_number']; ?>" disabled/>
          </div>
           <div class="form-group">
            <label for="" style="color:black;">Best Time To Call</label>
            <input type="text" name="customer_name" class="form-control" value="<?php echo $file['time_to_call']; ?>" disabled/>
          </div>
           <div class="form-group">
            <label for="" style="color:black;">Message</label>
            <!--<input type="text" name="email" class="form-control" value="<?php echo $file['description']; ?>" disabled/>-->
            <textarea name="name" class="form-control" id="help-you" cols="2" rows="2" placeholder=""   value="" disabled ><?php echo $file['description']; ?></textarea>
          </div>
...
<div id="Modal_Edit_<?php echo $file['id']; ?>" class="modal fade" role="dialog">
      <div class="modal-dialog">
        <div class="modal-content modal-lg">
          ...
          <div class="modal-body">
           <form method="post" action="contact-update" id="form">
              <div class="row">
        <div class="col-sm-12">
          <div class="form-group">
               <input type="hidden" name="id" value="<?php echo $file['id']; ?>" />
            ...
            <!--<textarea name="name" class="form-control" id="help-you" cols="2" rows="2" placeholder=""   value="" ><?php echo $file['date']; ?></textarea>-->
            <input type="text" name="name" class="form-control" value="<?php echo $file['name']; ?>" />
          </div>
          <div class="form-group">
            <label for="" style="color:black;">Email</label>
           <!--<textarea name="email" class="form-control" id="help-you" cols="2" rows="2" placeholder=""   value="" ><?php echo $file['email']; ?></textarea>-->
           <input type="text" name="email" class="form-control" value="<?php echo $file['email']; ?>" />
          </div>
          
           <div class="form-group">
            <label for="" style="color:black;">Phone Number </label>
            <!--<textarea name="phone_number" class="form-control" id="help-you" cols="2" rows="2" placeholder=""   value="" ><?php echo $file['phone_number']; ?></textarea>-->
            <input type="text" name="phone_number" class="form-control" value="<?php echo $file['phone_number']; ?>" />
          </div>
           <div class="form-group">
            <label for="" style="color:black;">Best Time To Call</label>
            <input type="text" name="time_to_call" class="form-control" value="<?php echo $file['time_to_call']; ?>" />
          </div>
           <div class="form-group">
            <label for="" style="color:black;">Message</label>
            <!--<input type="text" name="email" class="form-control" value="<?php echo $file['description']; ?>" disabled/>-->
            <textarea name="description" class="form-control" id="help-you" cols="2" rows="2" placeholder=""   value=""  ><?php echo $file['description']; ?></textarea>
          </div>
