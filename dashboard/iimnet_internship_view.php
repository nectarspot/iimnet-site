...
<td>
				...
				<a href="internship-delete.php?id=<?php echo $file['id']; ?>" class="btn btn-danger btn-sm1 " style="width:28px; padding: 6px 0px; "><i class="fa fa-trash"></i></a>
                        </td>
    </tr>
      ...
      <div class="modal-dialog">
        ...
        <div class="col-sm-12">
          ...
          <div class="form-group">
           ...
           <input type="text" name="internship" class="form-control" id="help-you" placeholder=""   value="<?php echo $file['internship']; ?>" disabled>
          </div>
           <div class="form-group">
            <label for="" style="color:black;"> Internship Type</label>
            <input type="text" name="internship_type" class="form-control" id="help-you" placeholder=""   value="<?php echo $file['internship_type']; ?>" disabled>
          </div>
           <div class="form-group">
...
<div id="Modal_Edit_<?php echo $file['id']; ?>" class="modal fade" role="dialog">
      <div class="modal-dialog">
        <div class="modal-content modal-lg">
          ...
          <div class="modal-body">
            <form method="post" action="internship-update" id="form">
               <div class="row">
        <div class="col-sm-12">
             <div class="form-group">
            <label for="" style="color:black;">First Name</label>
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            <label for="" style="color:black;">Internship</label>
           <input type="text" name="internship" class="form-control" id="help-you" placeholder=""   value="<?php echo $file['internship']; ?>" >
          </div>
           <div class="form-group">
            <label for="" style="color:black;"> Internship Type</label>
            <input type="text" name="internship_type" class="form-control" id="help-you" placeholder=""   value="<?php echo $file['internship_type']; ?>" >
          </div>
           <div class="form-group">
            <label for="" style="color:black;">Start Date</label>
