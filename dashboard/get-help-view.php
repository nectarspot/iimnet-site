    ...
    setTimeout(function() {
        ...
        <div class="table-wrapper table-responsive">
           ...
           <table id="example" class="table-striped"> 
            ...
            $sql = "SELECT * FROM iim_gethelp order by id desc";
      ...
      <td><?php echo $file['date']; ?></td>
        <td><?php echo $file['ip_address']; ?></td>
                        ...
                        <td>
                            ...
                            <form method="post" action="gethelp_status" id="form" class="mb-0">
				...
				<a href="get-help-delete.php?id=<?php echo $file['id']; ?>" class="btn btn-danger btn-sm1 " style="width:28px; padding: 6px 0px; "><i class="fa fa-trash"></i></a>
                        </td>
    </tr>
        ...
        <div class="col-sm-12">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <input type="text" name="answer" class="form-control" id="help-you" placeholder=""   value="<?php echo $file['looking_for']; ?>" disabled>
          </div>
           <div class="form-group">
...
<div id="Modal_Edit_<?php echo $file['id']; ?>" class="modal fade" role="dialog">
      <div class="modal-dialog">
        <div class="modal-content modal-lg">
          ...
          <div class="modal-body">
            <form method="post" action="get-help-update" id="form">
              <div class="row">
        <div class="col-sm-12">
             <div class="form-group">
            <label for="" style="color:black;">First Name</label>
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            <label for="" style="color:black;">Is the above phone number also a WhatsApp number?</label>
           <input type="text" name="whatsup_number" class="form-control" id="help-you" placeholder=""   value="<?php echo $file['whatsup_number']; ?>" >
          </div>
           <div class="form-group">
            <label for="" style="color:black;"> Language Preference</label>
            <input type="text" name="language" class="form-control" id="help-you" placeholder=""   value="<?php echo $file['language']; ?>" >
          </div>
           <div class="form-group">
            <label for="" style="color:black;">I am looking for</label>
            <input type="text" name="category_type" class="form-control" id="help-you" placeholder=""   value="<?php echo $file['category_type']; ?>" >
          </div>
           <div class="form-group">
            <label for="" style="color:black;">I am looking for the above within</label>
            <input type="text" name="looking_for" class="form-control" id="help-you" placeholder=""   value="<?php echo $file['looking_for']; ?>" >
          </div>
           <div class="form-group">
            <label for="" style="color:black;">Brief description about your need (optional)</label>
            <textarea name="description" class="form-control" id="help-you" cols="5" rows="5" placeholder=""   value="" ><?php echo $file['description']; ?></textarea>
          </div>
