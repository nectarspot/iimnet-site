            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 align-self-center">
                        <h4 class="page-title">Get Update Details</h4>
    ...
    setTimeout(function() {
        ...
        <div class="table-wrapper table-responsive">
           ...
           <table id="example" class="table-striped"> 
            ...
            $sql = "SELECT * FROM iim_get_update order by id desc";
...
<!--                            <form method="post" action="mba_status" id="form" class="mb-0">-->
...
<!--                        </td>-->
				...
				<a href="get-update-delete.php?id=<?php echo $file['id']; ?>" class="btn btn-danger btn-sm1 " style="width:28px; padding: 6px 0px; "><i class="fa fa-trash"></i></a>
                        </td>
    </tr>
...
<!--          </div>-->
          ...
          <!--  <input type="text" name="answer" class="form-control" id="help-you" placeholder=""   value="<?php echo $file['file_name']; ?>" disabled>-->
          <!--</div>-->
<!--            <div class="form-group">-->
...
<!--          </div>-->
<!--          <div class="modal-body">-->
<!--            <form method="post" action="mba-update" id="form">-->
<!--               <div class="row">-->
<!--        <div class="col-sm-12">-->
<!--              <div class="form-group">-->
<!--            <label for="" style="color:black;">First Name</label>-->
