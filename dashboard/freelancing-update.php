...
$update="update iim_freelancing set   first_name='".$first_name."' , last_name='".$last_name."' , email='".$email."' , phone_number='".$phone_number."' ,  city='".$city."' , freelancing='".$freelancing."' , freelancing_type='".$freelancing_type."' , start_date='".$start_date."' , end_date='".$end_date."' , answer='".$answer."' , answer1='".$answer1."' , position='".$position."' , drive_link='".$drive_link."' , status='".$status."'    where id='".$id."'";
