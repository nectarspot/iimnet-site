            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 align-self-center">
                        <h4 class="page-title">Volunteer Details</h4>
    ...
    setTimeout(function() {
        ...
        <div class="table-wrapper table-responsive">
           ...
           <table id="example" class="table-striped"> 
            ...
            $sql = "SELECT * FROM iim_volunteer order by id desc";
...
<td>
                            ...
                            <form method="post" action="volunteer_status" id="form" class="mb-0">
				...
				<a href="volunteer-delete.php?id=<?php echo $file['id']; ?>" class="btn btn-danger btn-sm1 " style="width:28px; padding: 6px 0px; "><i class="fa fa-trash"></i></a>
                        </td>
    </tr>
      ...
      <div class="modal-dialog">
        <div class="modal-content modal-lg">
          <div class="modal-header">
            <h4 class="modal-title"> Volunteer View  Details</h4>
        ...
        <div class="col-sm-12">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            <label for="" style="color:black;">Whatsup Number</label>
           <input type="text" name="answer" class="form-control" id="help-you" placeholder=""   value="<?php echo $file['whatsup_number']; ?>" disabled>
          </div>
           <div class="form-group">
            <label for="" style="color:black;">Language</label>
            <input type="text" name="answer" class="form-control" id="help-you" placeholder=""   value="<?php echo $file['language']; ?>" disabled>
          </div>
           <div class="form-group">
           
           <div class="form-group">
            <label for="" style="color:black;">Category Type</label>
            <input type="text" name="answer" class="form-control" id="help-you" placeholder=""   value="<?php echo $file['category_type']; ?>" disabled>
            <!--<textarea name="answer" class="form-control" id="help-you" cols="5" rows="5" placeholder=""   value="" disabled><?php echo $file['category_type']; ?></textarea>-->
          </div>
          
            <div class="form-group">
            <label for="" style="color:black;">Status</label>
            <input type="text" name="answer" class="form-control" id="help-you" placeholder=""   value="<?php echo $file['status']; ?>" disabled>
          </div>
            <div class="form-group">
...
<div id="Modal_Edit_<?php echo $file['id']; ?>" class="modal fade" role="dialog">
      <div class="modal-dialog">
        <div class="modal-content modal-lg">
          <div class="modal-header">
            <h4 class="modal-title">Volunteer Edit  Details</h4>
             <button type="button" class="close" data-dismiss="modal" aria-label="Close">
             <span aria-hidden="true"  style="color:#000000;">&times;</span>
                    </button>
          </div>
          <div class="modal-body">
            <form method="post" action="volunteer-update" id="form">
               <div class="row">
        <div class="col-sm-12">
             <div class="form-group">
            <label for="" style="color:black;">First Name</label>
           <input type="hidden" name="id" class="form-control" id="help-you" placeholder=""   value="<?php echo $file['id']; ?>" disabled>
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            <label for="" style="color:black;">Whatsup Number</label>
           <input type="text" name="whatsup_number" class="form-control" id="help-you" placeholder=""   value="<?php echo $file['whatsup_number']; ?>" disabled>
          </div>
           <div class="form-group">
            <label for="" style="color:black;">Language</label>
            <input type="text" name="language" class="form-control" id="help-you" placeholder=""   value="<?php echo $file['language']; ?>" disabled>
          </div>
           <div class="form-group">
           ...
           <input type="text" name="answer" class="form-control" id="help-you" placeholder=""   value="<?php echo $file['category_type']; ?>" disabled>
            ...
            <div class="form-group">
            <label for="" style="color:black;">Date</label>
            <input type="text" name="date" class="form-control" id="help-you" placeholder=""   value="<?php echo $file['date']; ?>" disabled>
          </div>
            <div class="form-group">
            <label for="" style="color:black;">IP Address</label>
            <input type="text" name="ip_address" class="form-control" id="help-you" placeholder=""   value="<?php echo $file['ip_address']; ?>" disabled>
          </div>
