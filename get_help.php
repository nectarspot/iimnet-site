...
$looking_for = mysqli_real_escape_string($link, $_POST['looking_for']);
...
$sql = "INSERT INTO iim_gethelp (first_name, last_name,email,  phone_number, city,whatsup_number,language,category_type,looking_for,description,status, date, ip_address)
 VALUES ('$first_name', '$last_name',  '$email',   '$phone_number', '$city', '$whatsup_number','$language','$category_type','$looking_for', '$description','$status', '$current_date', '$ipaddress')";
 //$sql = mysql_insert_id();
       ...
       <table border='0' cellpadding='0' cellspacing='0' align='center' width='600' style='border-collapse: collapse; border-spacing: 0; padding: 0; max-width: 600px;' class='wrapper'>
         <tr>
           <td style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 20px 20px 0px 20px; font-family: sans-serif;'>
               ...
               <p>$first_name $last_name is interested to join us as Covid-19 Helpline. Please find the details <a href='https://iimnet.com/dashboard/index'> here. </a></p>
